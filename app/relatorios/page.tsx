...
export default function RelatoriosPage() {
  ...
  const sentCount = reports.filter(report => report.status === 'Enviado').length
  const pendingCount = reports.filter(report => report.status === 'Pendente').length
  ...
  return (
    <ProtectedRoute>
      <ModuleAccessWrapper moduleName="relatorios" moduleDisplayName="Relatórios">
        <AppShell>
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="text-muted-foreground text-sm sm:text-base">Gerencie os relatórios mensais dos clientes</p>
              </div>
              <Dialog>
