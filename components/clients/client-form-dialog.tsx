...
import { Plus, Loader2, Building2, MessageSquare, TrendingUp } from 'lucide-react'
import { createClient, updateClient, type Client } from '@/lib/data/clients'
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Tabs defaultValue="basic" className="mt-4">
            ...
            <TabsContent value="basic" className="space-y-4 mt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  <Label htmlFor="contract_start_date">Data de Início do Contrato *</Label>
                  <Input
                ...
                <div className="grid gap-2">
                  <Label htmlFor="contract_end_date">Data de Fim do Contrato *</Label>
                  <Input
            ...
            <TabsContent value="whatsapp" className="space-y-4 mt-4">
              <div className="rounded-lg border border-border bg-secondary/30 p-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Configure o grupo do WhatsApp para comunicação com o cliente.
                </p>
